        ...
        describe("Distance") {
            ...
            describe("Optimized with zeroes") {
                withData(
                    ...
                    "X" to Arb.triple(arbCoordinate, Arb.of(0f), Arb.of(0f)),
                    "Y" to Arb.triple(Arb.of(0f), arbYCoordinate, Arb.of(0f)),
                    "Z" to Arb.triple(Arb.of(0f), Arb.of(0f), arbCoordinate),
                ) { (_, arbCoordinates) ->
...
data class HeadingTestCase(val expectedHeading: Float, val xDiff: Float, val zDiff: Float) :
    ...
    companion object {
        ...
        private val ZERO = HeadingTestCase(0f, -0f, -1f)
        private val SEVEN_POINT_FIVE =
            HeadingTestCase(7.5f, -(SQRT_2 - 1f) * (SQRT_3 - SQRT_2), -1f)
        private val FIFTEEN = HeadingTestCase(15f, SQRT_3 - 2f, -1f)
        private val TWENTY_TWO_POINT_FIVE = HeadingTestCase(22.5f, 1f - SQRT_2, -1f)
        private val THIRTY = HeadingTestCase(30f, -SQRT_3 / 3f, -1f)
        private val THIRTY_SEVEN_POINT_FIVE =
            HeadingTestCase(37.5f, -(SQRT_2 + 1f) * (SQRT_3 - SQRT_2), -1f)
        private val FORTY_FIVE = HeadingTestCase(45f, -1f, -1f)

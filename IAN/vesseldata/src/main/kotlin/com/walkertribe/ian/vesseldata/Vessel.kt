...
/**
 * Corresponds to the &lt;vessel&gt; element in vesselData.xml. Note that this represents an entire
 * class of ships, not an individual one.
 *
 * @author rjwut
 */
...
internal constructor(
    ...
    /**
     * Returns the base production coefficient. This value affects how quickly the base produces new
     * ordnance.
     */
    ...
    internal constructor(
        ...
        ordnanceStorage =
            xml["torpedo_storage"].associate {
                val code = it.requiredString("type")
                requireNotNull(OrdnanceType[code]) { "Invalid ordnance type code: $code" } to
                    it.requiredInt("amount")
            },

                                        ...
                                        in 7..9 -> "2.7-9.*"
                                            ...
                                            val minimum =
                                                Array(minorLength - 1) { "0" }
                                                    .joinToString("", prefix = "1")
                                            val maximum =
                                                Array(minorLength) { "9" }.joinToString("")
                                            "2.$minimum-$maximum.*"
                                        }
                                    }
                                )
                ...
                OrdnanceType.entries.forEach { ordnanceType ->
                    describe(ordnanceType.toString()) {
                        ...
                        it("Arbitrary label: false") {
                            Arb.string().filterNot(labels::contains).forAll {
                                !ordnanceType.hasLabel(it)
                            }
                        }
                    }
                }

...
class Vessel internal constructor(
    ...
    internal constructor(xml: Xml) : this(
        ...
        description = xml.child("long_desc")?.str("text")?.caretToNewline() ?: "",
    )
    ...
    private companion object {
        ...
        fun build(broadType: CharSequence): Set<String> =
            broadType.toString().lowercase().splitSpaceDelimited().toSet()
    }
}

...
class TestVessel(
    ...
    suspend fun test(vessel: Vessel?, vesselData: VesselData?) {
        ...
        vessel.description shouldBeEqual description.replace('^', '\n')
    ...
    fun serialize(): Xml = Xml(
        ...
        node("long_desc", "text" to description)
    ...
    companion object {
        fun arbitrary(): Arb<TestVessel> {
            ...
            return Arb.bind(
                Arb.int(),
                Arb.enum<TestFaction>(),
                arbXmlString,
                Arb.set(Arb.string(minSize = 1, codepoints = Codepoint.az()), slippage = 90),

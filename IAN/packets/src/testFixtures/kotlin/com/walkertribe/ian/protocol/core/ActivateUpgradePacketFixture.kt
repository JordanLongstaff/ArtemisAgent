...
sealed class ActivateUpgradePacketFixture(
    ...
    class Data
    internal constructor(packet: ActivateUpgradePacket, private val expectedSubtype: Int) :
    ...
    override suspend fun describeMore(scope: DescribeSpecContainerScope) {
        scope.it("Correct subtype chosen according to version") {
            versionGen.checkAll { ActivateUpgradePacket(it) shouldBeEqual packet }
        }
    }

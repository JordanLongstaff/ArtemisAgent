...
object PlayerShipParser : AbstractObjectParser<ArtemisPlayer>(ObjectType.PLAYER_SHIP) {
    ...
    override fun parseDsl(reader: PacketReader) =
        ArtemisPlayer.Dsl.Player.apply {
            ...
            energy = reader.readFloat(PlayerBit.ENERGY)
            shieldsActive = reader.readBool(PlayerBit.SHIELD_STATE, 2)
    ...
    override fun getBitCount(version: Version): Int =
        PlayerBit.entries.count { it.getIndex(version) >= 0 }
}

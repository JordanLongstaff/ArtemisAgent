            ...
            withData(
                ...
                withData(
                    ...
                    thirdTestCaseSet.forEach { sortingTestCase ->
                        ...
                        val expectedSort = sortingTestCase.expectedSortIndices.map { unsortedTriples[it] }
...
enum class SortingTestCase(
    ...
    override fun dataTestName(): String {
        val sortFirst = if (sortByFirst) "S" else "Don't s"
        val sortSecond = if (sortBySecond) "" else " don't"
        val sortThird = if (sortByThird) "" else " don't"
        return "${sortFirst}ort first,$sortSecond sort second,$sortThird sort third"
    }
}

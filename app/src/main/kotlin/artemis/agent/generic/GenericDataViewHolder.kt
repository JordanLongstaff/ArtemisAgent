...
class GenericDataViewHolder private constructor(private val entryBinding: GenericDataEntryBinding) :
    RecyclerView.ViewHolder(entryBinding.root) {
    var name: CharSequence?
        get() = entryBinding.entryNameLabel.text
        set(text) {
            entryBinding.entryNameLabel.text = text
        }
    ...
    var data: CharSequence?
        ...
        set(text) {
            ...
            entryBinding.entryDataLabel.visibility =
    ...
    constructor(
        parent: ViewGroup
    ) : this(GenericDataEntryBinding.inflate(LayoutInflater.from(parent.context), parent, false))

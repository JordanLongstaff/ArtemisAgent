...
class FragmentViewBindingDelegate<VB : ViewBinding>(private val viewBinder: ViewBinder<VB>) :
    ...
    override fun getValue(thisRef: Fragment, property: KProperty<*>): VB {
        check(Looper.myLooper() == Looper.getMainLooper()) { "Must be called from main thread" }

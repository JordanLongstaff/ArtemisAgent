...
/**
 * Notification service that starts whenever the app shifts to the background so that the connection
 * can stay afloat and notifications will be pushed. Also contains the logic of allowing biomechs to
 * be re-frozen when the appropriate button is pressed on a notification.
 */
class NotificationService : LifecycleService() {
    ...
    /**
     * Receives possible intents to re-freeze Biomechs with the specified ID. Notification also gets
     * dismissed at the same time, if the Biomech was found.
     */
